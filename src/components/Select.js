...
import defaultArrowRenderer from 'react-select/lib/utils/defaultArrowRenderer';
import defaultClearRenderer from 'react-select/lib/utils/defaultClearRenderer';
...
class Select extends React.Component {
  ...
  getOptionLabel(op) {
    return getLabel(op, this.props.labelKey, this.props.getOptionLabel);
  }
...
Select.propTypes = {
  'aria-describedby': PropTypes.string, // html id(s) of element(s) that should be used to describe this input (for
                                        // assistive tech)
  ...
  backspaceToRemoveMessage: PropTypes.string,  // message to use for screenreaders to press backspace to remove the
  ...
  filterOptions: PropTypes.any,         // boolean to enable default filtering or function to filter the options array
  ...
  isLoading: PropTypes.bool,            // whether the Select is loading externally or not (such as options being
                                        // loaded)
  isMenuOpen: PropTypes.bool,           // whether the menu is always Open
  joinValues: PropTypes.bool,           // joins multiple values into a single form field with the delimiter (legacy
                                        // mode)
  labelKey: PropTypes.string,           // path of the label value in option objects,
  getOptionLabel: PropTypes.func,       // function to retrieve label value from option options, if present, overrides
                                        // labelKey,
  matchPos: PropTypes.string,           // (any|start) match the start or entire string when filtering
  matchProp: PropTypes.string,          // (any|label|value) which option property to filter on
  menuBuffer: PropTypes.number,         // optional buffer (in px) between the bottom of the viewport and the bottom of
                                        // the menu
  ...
  onMenuScrollToBottom: PropTypes.func, // fires when the menu is scrolled to the bottom; can be used to paginate
                                        // options
  ...
  scrollMenuIntoView: PropTypes.bool,   // boolean to enable the viewport to shift so that the full menu fully visible
                                        // when engaged
  searchable: PropTypes.bool,           // whether to enable searching feature or not
  simpleValue: PropTypes.bool,          // pass the value to onChange as a simple value (legacy pre 1.0 mode), defaults
                                        // to false
