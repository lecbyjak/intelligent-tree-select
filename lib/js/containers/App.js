    ...
    _createClass(App, [{
        ...
        value: function _simplyfyData(responseData, valueKey, childrenKey) {
            ...
            for (var i = 0; i < responseData.length; i++) {
                //deep clone
                var data = JSON.parse(JSON.stringify(responseData[i]));
        ...
        key: '_getResponses',
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(searchString) {
                var _this2 = this;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_virtualizedTreeSelect2.default, _extends({
