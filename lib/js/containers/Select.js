...
var stringifyValue = function stringifyValue(value) {
    return typeof value === 'string' ? value : value !== null && (0, _stringify2.default)(value) || '';
}; /*!
...
var handleRequired = function handleRequired(value, multi) {
    ...
    return multi ? value.length === 0 : (0, _keys2.default)(value).length === 0;
};
    ...
    (0, _createClass3.default)(Select, [{
        ...
        value: function setInputValue(newValue) {
            if (this.props.onInputChange) {
                ...
                if (nextState != null && (typeof nextState === 'undefined' ? 'undefined' : (0, _typeof3.default)(nextState)) !== 'object') {
                    newValue = '' + nextState;
                }
            }
            this.setState({
        ...
        value: function getValueArray(value) {
            ...
            var props = (typeof nextProps === 'undefined' ? 'undefined' : (0, _typeof3.default)(nextProps)) === 'object' ? nextProps : this.props;
            if (props.multi) {
        ...
        value: function renderInput(valueArray, focusedOptionIndex) {
            ...
            var ariaOwns = (0, _classnames2.default)((_classNames = {}, (0, _defineProperty3.default)(_classNames, this._instancePrefix + '-list', isOpen), (0, _defineProperty3.default)(_classNames, this._instancePrefix + '-backspace-remove-message', this.props.multi && !this.props.disabled && this.state.isFocused && !this.state.inputValue), _classNames));
            ...
            if (this.props.disabled || !this.props.searchable) {
                var divProps = (0, _objectWithoutProperties3.default)(this.props.inputProps, []);


                var _ariaOwns = (0, _classnames2.default)((0, _defineProperty3.default)({}, this._instancePrefix + '-list', isOpen));
                return _react2.default.createElement('div', (0, _extends3.default)({}, divProps, {
                    'aria-expanded': isOpen,
                    'aria-owns': _ariaOwns,
                    'aria-activedescendant': isOpen ? this._instancePrefix + '-option-' + focusedOptionIndex : this._instancePrefix + '-value',
            ...
            if (this.props.autosize) {
                return _react2.default.createElement(_reactInputAutosize2.default, (0, _extends3.default)({ id: this.props.id }, inputProps, { className: className, minWidth: '5' }));
            }
            return _react2.default.createElement(
                'div',
                { className: className, key: 'input-wrap', style: { display: 'inline-block' } },
                _react2.default.createElement('input', (0, _extends3.default)({ id: this.props.id }, inputProps))
            );
        }
    }, {
        key: 'renderClear',
