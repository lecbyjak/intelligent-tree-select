...
const renderMembers = formApi => _react2.default.createElement(
    _reactstrap.FormGroup,
    null,
    _react2.default.createElement(
        _reactstrap.Button,
        { type: "button", onClick: () => formApi.addValue('siblings', ''), color: 'primary', size: "sm" },
        "Add term property"
    ),
    console.log('renderMembers', formApi),
    formApi.values.siblings && formApi.values.siblings.map((member, index) => _react2.default.createElement(
        _reactstrap.FormGroup,
        { key: index, className: "d-flex justify-content-between align-items-center m-1" },
        _react2.default.createElement(_reactForm.Field, {
            name: `${member}.key`,
        ...
        _react2.default.createElement(
            "span",
            { onClick: () => formApi.values.siblings.remove(index), style: { pointer: 'cursor' }, className: "Select-clear-zone",
                ...
                _react2.default.createElement(
                    ...
                    formApi => _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            null,
                            _react2.default.createElement(_reactForm.Field, { name: "termLabel", label: "Label (required)", component: RenderInput }),
                            _react2.default.createElement(_reactForm.Field, { name: "termID", label: "Term ID (required)", component: RenderInput }),
                            _react2.default.createElement(_reactForm.Field, { name: "termDescription", label: "Description", component: RenderInput }),
                            _react2.default.createElement(
                                _reactstrap.Button,
                                { color: "link",
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(_reactForm.Field, { name: "parent-term",
                                    options: this.options,
                                ...
                                _react2.default.createElement(_reactForm.Field, { name: "child-terms",
                                    options: this.options,
                                    filterOptions: this.filter,
